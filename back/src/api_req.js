...
module.exports = {
                    ...
                    .then(async data2 => {
                        ...
                        if (data2.Response == 'True') {
                            while (j < data2.Search.length) {
                                ...
                                if (exist == false) {
                                    var unseen = JSON.stringify({
                                        name: data2.Search[j].Title,
    ...
    film_by_id: function (id_movie) {
        return new Promise((resolve, reject) => {
            ...
            if (regex1.test(id_movie)) {
                console.log("premier fetch");
                fetch("http://www.omdbapi.com/?apikey=b52706c0&i=" + id_movie)
                    .then((res) => res.json())
                    .then(async data => {
                        if (data) {
                            console.log("icici---------------------------------------------------------");
